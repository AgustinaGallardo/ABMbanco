...
namespace ABMbanco.Reporte {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CLIENTESDataTable : global::System.Data.TypedTableBase<CLIENTESRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CLIENTESRow AddCLIENTESRow(string nombre, string apellido, int dni) {
...
namespace ABMbanco.Reporte.DataSet1TableAdapters {
    ...
    public partial class CLIENTESTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [CLIENTES] WHERE (([id_cliente] = @Original_id_cliente) AND ([nombre]" +
                " = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([dni] = @Origina" +
                "l_dni))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [CLIENTES] ([nombre], [apellido], [dni]) VALUES (@nombre, @apellido, " +
                "@dni);\r\nSELECT id_cliente, nombre, apellido, dni FROM CLIENTES WHERE (id_cliente" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CLIENTES] SET [nombre] = @nombre, [apellido] = @apellido, [dni] = @dni WHERE (([id_cliente] = @Original_id_cliente) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([dni] = @Original_dni));
SELECT id_cliente, nombre, apellido, dni FROM CLIENTES WHERE (id_cliente = @id_cliente)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-DBB4CIB\\SQLEXPRESS;Initial Catalog=AMBbancoProgII;Integrated " +
                "Security=True";
        }
        ...
        public virtual int Delete(int Original_id_cliente, string Original_nombre, string Original_apellido, int Original_dni) {
        ...
        public virtual int Insert(string nombre, string apellido, int dni) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string apellido, int dni, int Original_id_cliente, string Original_nombre, string Original_apellido, int Original_dni, int id_cliente) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, int dni, int Original_id_cliente, string Original_nombre, string Original_apellido, int Original_dni) {
